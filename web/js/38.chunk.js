...
/***/ (function(module, exports, __webpack_require__) {
	...
	var List = exports.List = function (_React$Component) {
	                ...
	                render: function render(data) {
	                    return _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            _antd.Button,
	                            { type: 'default', onClick: _this.goToNoticeDetail.bind(_this, data.key), style: { "marginRight": "20px" } },
	                            '\u67E5\u770B'
	                        ),
	                        _react2.default.createElement(
	                            _antd.Button,
	                            { type: 'primary', onClick: _this.goToNoticeEdit.bind(_this, data.key), style: { "marginRight": "20px" } },
	                            '\u4FEE\u6539'
	                        ),
	                        _react2.default.createElement(
	                            _antd.Popconfirm,
	                            { placement: 'left', title: '\u662F\u5426\u786E\u8BA4\u5220\u9664?', onConfirm: _this.deleteNotice.bind(_this, data.key),
	    ...
	    (0, _createClass3.default)(List, [{
	        ...
	        key: 'goToNoticeDetail',
	        value: function goToNoticeDetail(id) {
	            _reactRouter.hashHistory.push("/notice/detail/" + id);
	        }
	    }, {
	        key: 'goToNoticeEdit',
	        value: function goToNoticeEdit(id) {
	            _reactRouter.hashHistory.push("/notice/edit/" + id);
	        }
	    }, {
	        key: 'deleteNotice',
	        value: function deleteNotice(id) {
	            var that = this;
	            ajax({
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        _antd.Button,
	                        { icon: 'plus', onClick: this.addNotice, style: { "marginBottom": "20px" } },
	                        '\u6DFB\u52A0\u516C\u544A'
	                    ),
