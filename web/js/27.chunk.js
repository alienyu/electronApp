...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _financingItem = __webpack_require__(1184);
	
	var _financingItem2 = _interopRequireDefault(_financingItem);
	
	var _investItem = __webpack_require__(1185);
	
	var _investItem2 = _interopRequireDefault(_investItem);
	
	var _deadlineItem = __webpack_require__(1186);
	
	var _deadlineItem2 = _interopRequireDefault(_deadlineItem);
	
	var _mortgageItem = __webpack_require__(1187);
	...
	var DebtsForm = exports.DebtsForm = function (_React$Component) {
	    ...
	    function DebtsForm(props) {
	        ...
	        _this.state = {
	            ...
	            "receivedItemsNum": "" };
	        ['handleSubmit', 'resetForm', 'mortgageChange', 'guaranteeChange'].forEach(function (m) {
	    ...
	    (0, _createClass3.default)(DebtsForm, [{
	        ...
	        key: 'financingProfitsCheck',
	        value: function financingProfitsCheck(rule, value, callback) {
	        ...
	        key: 'investCheck',
	        value: function investCheck(rule, value, callback) {
	        ...
	        key: 'deadlineCheck',
	        value: function deadlineCheck(rule, value, callback) {
	            if (!value.min || !value.max) {
	                callback('请输入期限!');
	            } else {
	                if (value.max < value.min) {
	...
	var FinancingItem = function (_React$Component) {
	    ...
	    (0, _createClass3.default)(FinancingItem, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                RadioGroup,
	                { value: this.state.isNeed, onChange: this.handleRadioChange, disabled: this.props.disabled },
	                _react2.default.createElement(
	                    _antd.Radio,
	                    { value: '0' },
	                    '\u65E0\u8981\u6C42'
	                ...
	                _react2.default.createElement(
	                    _antd.Radio,
	                    { value: '1' },
	                    _react2.default.createElement(_antd.Input, { value: this.state.number, onChange: this.handleNumberChange, disabled: this.props.disabled || this.state.isNeed == "0" }),
	                    '\u4E07\u5143(\u4EE5\u4E0A)'
	                )
	            );
	        }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _benefitsItem = __webpack_require__(1189);
	...
	var StockForm = exports.StockForm = function (_React$Component) {
	    ...
	    (0, _createClass3.default)(StockForm, [{
	        ...
	        key: 'companyProfitsCheck',
	        value: function companyProfitsCheck(rule, value, callback) {
	            if (value.isNeed == "0" || value.isNeed > 0 && value.number) {
	                callback();
	                return;
	            }
	        ...
	        key: 'estimateBenefitsCheck',
	        value: function estimateBenefitsCheck(rule, value, callback) {
	            if (value.times) {
	                callback();
	                return;
	            }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _debtsForm = __webpack_require__(1183);
	
	var _debtsForm2 = _interopRequireDefault(_debtsForm);
	
	var _stockForm = __webpack_require__(1188);
	
	var _stockForm2 = _interopRequireDefault(_stockForm);
	
	var _purchaseForm = __webpack_require__(1190);
	...
	var New = exports.New = function (_React$Component) {
	    ...
	    function New(props) {
	        ...
	        return (0, _possibleConstructorReturn3.default)(this, (New.__proto__ || (0, _getPrototypeOf2.default)(New)).call(this, props));
	    }
