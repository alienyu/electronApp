...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _searchForm = __webpack_require__(1271);
	    ...
	    (0, _createClass3.default)(SearchForm, [{
	        ...
	        value: function handleSubmit(page) {
	            ...
	            this.props.form.validateFields(function (err, values) {
	                ...
	                var params = {};
	                if (values.time) {
	                    params.startTime = (0, _moment2.default)(values.time[0], "YYYY-MM-DD HH:mm");
	                    params.endTime = (0, _moment2.default)(values.time[1], "YYYY-MM-DD HH:mm");
	                }
	                ajax({
